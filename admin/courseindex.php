...
<head>
  ...
  <title>Lonergan Resource Administration | Courses</title>
...
<div id="wrap">
  ...
  <div id="content-sides">
    ...
    <div style="float: left; width: 50%;">
      ...
      <form action="coursedb.php?a=add" method="POST">
        <div id="contact">
          ...
          <br>
          <label>Instructor</label> <input type="text" name="name"><br>
          <br>
    ...
    <div style="float: right; width: 50%;">
      ...
      <?php
      $result = $mysqli->query("SELECT * FROM courses ORDER BY name ASC");
      while($row = $result->fetch_array(MYSQLI_ASSOC)) {
        echo "
        <div style=\"margin-left: 90px;\">
          <div style=\"float: left; width: 90px; margin-left: -90px; font-size: 120%;\">
            <a href=\"courseedit.php?id=" . $row['id'] . "\" title=\"Edit\"><i class=\"fa fa-pencil\"></i></a> &nbsp; 
            <a href=\"coursedb.php?a=delete&id=" . $row['id'] . "\" onClick=\"return(confirm('Are you sure you want to delete this record?'));\" title=\"Delete\"><i class=\"fa fa-trash-o\"></i></a> &nbsp;
            <a href=\"../course.php?" . $row['id'] . "\" target=\"new\" title=\"View\"><i class=\"fa fa-eye\"></i></a>
          </div>
