...
<head>
  ...
  <title>Lonergan Resource Administration | Dissertations</title>
...
<div id="wrap">
  ...
  <div id="content-sides">
    ...
    <a href="dissexport.php" style="float: right;">Export Dissertations</a>
    <div style="clear: both;"></div><br>
    
    <div style="float: left; width: 50%;">
      <h1>Add Dissertation</h1>
      
      <form action="dissdb.php?a=add" method="POST">
        <div id="contact">
    ...
    <div style="float: right; width: 50%;">
      <h1>Available Dissertations</h1>
      
      <?php
      $result = $mysqli->query("SELECT * FROM dissertations ORDER BY name ASC");
      while($row = $result->fetch_array(MYSQLI_ASSOC)) {
        echo "
        <div style=\"margin-left: 90px;\">
          <div style=\"float: left; width: 90px; margin-left: -90px; font-size: 120%;\">
            <a href=\"dissedit.php?id=" . $row['id'] . "\" title=\"Edit\"><i class=\"fa fa-pencil\"></i></a> &nbsp; 
            <a href=\"dissdb.php?a=delete&id=" . $row['id'] . "\" onClick=\"return(confirm('Are you sure you want to delete this record?'));\" title=\"Delete\"><i class=\"fa fa-trash-o\"></i></a> &nbsp;
            <a href=\"../dissertations.php?" . $row['id'] . "\" target=\"new\" title=\"View\"><i class=\"fa fa-eye\"></i></a>
          </div>
