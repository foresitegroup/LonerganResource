...
<div id="wrap">
  ...
  <div id="content-sides">
    ...
    <div style="float: right; width: 50%;">
      ...
      <?php
      $result = mysql_query("SELECT * FROM books ORDER BY name,date ASC");
      while($row = mysql_fetch_array($result)) {
        echo "
        <div style=\"margin-left: 90px;\">
          <div style=\"float: left; width: 90px; margin-left: -90px;\">
            <a href=\"bookedit.php?id=" . $row['id'] . "\">edit</a> | 
            <a href=\"bookdb.php?a=delete&id=" . $row['id'] . "\" onClick=\"return(confirm('Are you sure you want to delete this record?'));\">delete</a>
          </div>
