/*
        DatePicker v4b2 rc1 by frequency-decoder.com
                        ...
                        for(var rows = 0; rows < 7; rows++) {
                                ...
                                for(var cols = 0; cols < colspanTotal; cols++) {                                                                                
                                        if(rows === 0 || (this.showWeeks && cols === 0)) {
                                                ...
                                                setARIAProperty(col, "describedby", "col-" + cols + (this.showWeeks ? " row-" + rows : ""));
                ...
                if(!(this.disabledDays[weekDay] || String(yyyy)+m+d in this.disabledDates)) {
                        if(this.splitDate) {                                  
                                ...
                                var oldVal = elem.value,
                                    newVal = printFormattedDate(this.date, this.format);                                                                                            
