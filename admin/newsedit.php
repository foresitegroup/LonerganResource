...
<head>
  ...
  <title>Lonergan Resource Administration | Edit News & Events</title>
  ...
  <div id="content-sides">
    ...
    <form action="newsdb.php?a=edit" method="POST">
      <div id="contact">
        ...
        <textarea name="description" rows="6" cols="35" style="width: 400px; height: 300px;"><?php echo htmlspecialchars_decode($row['description']); ?></textarea><br>
        <br>
