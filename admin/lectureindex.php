      ...
      while($row = mysql_fetch_array($result)) {
        ...
        <div style=\"margin-left: 90px;\">
          <div style=\"float: left; width: 90px; margin-left: -90px;\">
            <a href=\"lectureedit.php?id=" . $row['id'] . "\">edit</a> | 
            <a href=\"lecturedb.php?a=delete&id=" . $row['id'] . "\" onClick=\"return(confirm('Are you sure you want to delete this record?'));\">delete</a>
          </div>
