...
switch ($_GET['a']) {
  case "add":
    $query = "INSERT INTO journals (titleid, volume, number, description, file1) VALUES ('" . $_POST['titleid'] . "', '" . $_POST['volume'] . "', '" . $_POST['number'] . "', '" . htmlspecialchars($_POST['description'], ENT_QUOTES) . "', '" . $_POST['file1'] . "', '" . $_POST['display'] . "')";
    break;
  case "edit":
